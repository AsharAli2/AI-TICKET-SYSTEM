    ...
    <div className="min-h-screen flex items-center justify-center bg-black text-white">
      <Card className="w-[380px] border-gray-800 bg-neutral-900 shadow-xl">
        <CardHeader>
          ...
          <CardDescription>Join the AI ticketing system</CardDescription>
        </CardHeader>
        <CardContent>
          <form className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="name">Name</Label>
              <Input id="name" type="text" placeholder="John Doe" className="bg-neutral-800 border-gray-700 text-white"/>
            </div>
            <div className="space-y-2">
